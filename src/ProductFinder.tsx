...
const QUESTIONS: Question[] = [
  {
    id: 'q1_location',
    type: 'single',
    title: 'Where do you want to install the camera(s)?',
    options: [
      { id: 'indoors', label: 'Indoors' },
      { id: 'outdoors', label: 'Outdoors, general area' },
      { id: 'front_door', label: 'Front door / main entrance' },
      { id: 'remote_spot', label: 'A remote spot with no power or WiFi' },
  ...
  },
  {
    ...
    options: [
      { id: 'deter', label: 'Deter intruders (alarm/floodlight)' },
      { id: 'see_door', label: "See who's at the door or getting packages" },
      { id: 'track', label: 'Automatically track people or vehicles' },
      { id: 'record_247', label: 'General 24/7 recording / proof if something happens' },
      { id: 'not_sure', label: 'Not sure yet' },
    ],
  },
  {
    id: 'q3_power',
    type: 'single',
    title: 'What power and connectivity do you have at that location?',
    options: [
      { id: 'power_wifi', label: 'Power outlet + WiFi nearby' },
      { id: 'wifi_only', label: 'WiFi available, but no power outlet' },
      { id: 'sunlight', label: 'No outlet, no WiFi — but sunlight available' },
      { id: 'off_grid', label: 'Truly off-grid — I need 4G cellular' },
      { id: 'poe', label: 'I want a wired multi-camera (PoE) system' },
      { id: 'not_sure', label: 'Not sure yet' },
    ],
  },
  {
    id: 'q4_capabilities',
    type: 'multiple',
    title: 'Select any additional capabilities needed',
    options: [
      { id: 'siren', label: 'Built-in siren or alarm' },
      { id: 'spotlight', label: 'Spotlight / floodlight' },
      { id: 'zoom', label: 'Optical zoom' },
      { id: 'audio', label: 'Two-way audio' },
      { id: 'just_record', label: 'Just recording is fine' },
      { id: 'not_sure', label: 'Not sure yet' },
    ],
  },
  {
    id: 'q5_monitor',
    type: 'single',
    title: 'How should the camera monitor the area?',
    options: [
      { id: 'rotate', label: 'Rotate and follow people/vehicles automatically' },
      { id: 'fixed', label: 'Fixed wide-angle or panoramic view' },
      { id: 'magnetic', label: 'Magnetic, portable — I want to move it around easily' },
  ...
  },
  {
    ...
    options: [
      ...
      { id: 'pair', label: 'A pair (2 cameras)' },
      { id: 'small_kit', label: 'A small kit (4 cameras)' },
      { id: 'large_system', label: 'A large system (6–12 cameras)' },
      { id: 'not_sure', label: 'Not sure yet' },
    ],
  },
];
